...
export const DocumentCard2 = ({document}) => {
  ...
  return (
    <tr key={document.id}>
      ...
      <td><div><Button id="edit-button" className=" btn-primary" variant="primary" onClick={()=> {navigate(`/documents/edit/${document.id}`)}}>Edit</Button>{' '}
      <Button id="delete-button" className=" btn-secondary" onClick={handleRelease}>Release</Button></div></td>
